          ...
          <el-form-item class="input" v-if="ruleForm.chushengriqi" label="出生日期" prop="chushengriqi">
              <el-input v-model="ruleForm.chushengriqi" 
                placeholder="出生日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="名族" prop="mingzu">
          <el-input v-model="ruleForm.mingzu" 
              placeholder="名族" clearable  :readonly="ro.mingzu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="名族" prop="mingzu">
              <el-input v-model="ruleForm.mingzu" 
                placeholder="名族" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.bianjiriqi" label="编辑日期" prop="bianjiriqi">
              <el-input v-model="ruleForm.bianjiriqi" 
                placeholder="编辑日期" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主要成就" prop="zhuyaochengjiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主要成就"
                  v-model="ruleForm.zhuyaochengjiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyaochengjiu" label="主要成就" prop="zhuyaochengjiu">
                    <span>{{ruleForm.zhuyaochengjiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiguan = true;
            continue;
	            	            ...
	            	            if(o=='zhuyaochengjiu'){
            this.ruleForm.zhuyaochengjiu = obj[o];
	    this.ro.zhuyaochengjiu = true;
            continue;
          }
	            	            if(o=='xiangqing'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fanzhimingren/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fanzhimingrenCrossAddOrUpdateFlag = false;
                  this.parent.search();
