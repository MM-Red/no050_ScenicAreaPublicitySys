        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="特征" prop="tezheng">
          <el-input v-model="ruleForm.tezheng" 
              placeholder="特征" clearable  :readonly="ro.tezheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="特征" prop="tezheng">
              <el-input v-model="ruleForm.tezheng" 
                placeholder="特征" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="简介" prop="jianjie">
              <el-input v-model="ruleForm.jianjie" 
                placeholder="简介" readonly></el-input>
                                                                                                                              ...
                                                                                                                              <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="编辑日期" prop="bianjiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.bianjiriqi" 
                type="date"
                placeholder="编辑日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.bianjiriqi" label="编辑日期" prop="bianjiriqi">
              <el-input v-model="ruleForm.bianjiriqi" 
                placeholder="编辑日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主要原料" prop="zhuyaoyuanliao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主要原料"
                  v-model="ruleForm.zhuyaoyuanliao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyaoyuanliao" label="主要原料" prop="zhuyaoyuanliao">
                    <span>{{ruleForm.zhuyaoyuanliao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="由来" prop="youlai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="由来"
                  v-model="ruleForm.youlai" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.youlai" label="由来" prop="youlai">
                    <span>{{ruleForm.youlai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='tezheng'){
            this.ruleForm.tezheng = obj[o];
	    this.ro.tezheng = true;
            continue;
          }
	            	            if(o=='jianjie'){
	    ...
	    this.ro.jianjie = true;
            continue;
	            	            ...
	            	            if(o=='zhuyaoyuanliao'){
            this.ruleForm.zhuyaoyuanliao = obj[o];
	    this.ro.zhuyaoyuanliao = true;
            continue;
          }
	            	            if(o=='youlai'){
            this.ruleForm.youlai = obj[o];
	    this.ro.youlai = true;
            continue;
          }
	            	            if(o=='xiangqing'){
	    ...
	    this.ro.xiangqing = true;
            continue;
	            	            ...
	            	            if(o=='bianjiriqi'){
            this.ruleForm.bianjiriqi = obj[o];
	    this.ro.bianjiriqi = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmd3ysa/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fanzhimeishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fanzhimeishiCrossAddOrUpdateFlag = false;
                  this.parent.search();
